...
public:
    ...
    */
    tech_flag_t initFastrak(bool assert=false);
    ...
    */
    tech_flag_t getPose( Eigen::Vector3d &position, Eigen::Quaterniond &quat, int sensor=1, bool update=true );
     ...
     * Return: Returns a success/fall flag
    */
    tech_flag_t getPose( Eigen::Vector3d &position, Eigen::Matrix3d &rotation, int sensor=1, bool update=true );
     ...
     * Return: Returns a success/fall flag
    */
    tech_flag_t getPose( Eigen::Isometry3d &tf, int sensor=1, bool update=true );
typedef struct
{
    float data[4][7];
} fastrak_c_t;
